...
/**
 * AddAddressRequest DTO used to get information to add user address.
 */
@Schema(
        name = "Add User Address",
        description = "Schema to hold user address information to add new address"
)
@Data
public class AddAddressRequest {

    @Schema(
            description = "User name", example = "vnvivek"
    )
